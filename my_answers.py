...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # y - y_hat * f'(h), where the derivative of f(x) = x as the activation equals 1
        ...
        # weights_h_o * output_error_term * f'(hj)  --derivative of hidden unit
        hidden_error_term = hidden_error * hidden_outputs * (1 - hidden_outputs)
        
        # Weight step (input to hidden)
        # [:, None] is a numpy trick where None is an alias for newaxis, which creates an axis of length 1
